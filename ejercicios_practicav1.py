...
def ej2():
    ...
    # Suma
    print('El resultado de sumar',suma)


    # Resta
    print('el resultado de restar es',resta)

    # División
    print('el resultado de dividir es',division)

    # Multiplicación
    print('el resultado de multiplicar es',multiplicacion)
...
def ej3():
    ...
    nombcompl = (nombre,' ',apellido)
    nom_len = len(nombcompl)
    print(nom_len)
...
def ej4():
    ...
    print(palabra_1[0],palabra_2[0],palabra_3[0],palabra_4[0])
